<?php
  ...
  include("connection.php");
      ...
      if(isset($_POST['submit'])){
        ...
        $rent=$_POST['rent'];
$query = "INSERT INTO `vehicle`( `model`, `vehicle_number`, `Capacity`, `rent`) VALUES ('$model','$vehicle_number','$capacity','$rent')";
...
?>
<!-- This page is add car section where agency can add car. No user has access to this page-->
...
<?php if($_SESSION['type']=='agency'){?>
        <title>caRent || Add Car</title>
<!-- if user logged in header will be My booked cars-->
<?php } 
      else{?>
        <title>caRent || Agency Page</title>
<?php } ?>
...
<!--Main Section -->
    ...
    <div id="taxis" class="taxis_section layout_padding">
      ...
      <div class="container" style="padding: 6%;">
        ...
        <h1 class="our_text">Add<span style="color: #f4db31;"> &nbsp;Car</span></h1>
...
<form method="post" action="" style="padding: 20px; border: 2px solid yellow;">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control"  placeholder="Tata Wagaonar" name="model"required>
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Vehicle Number</label>
      <input type="text" class="form-control"  placeholder="DL2CK98111" name="vehicle_number"required>
    </div>
   <div class="form-group col-md-6">
      <label for="inputEmail4">Seating Capacity</label>
      <input type="number" class="form-control"  placeholder="0" name="capacity" required>
    </div>
    <div class="form-group col-md-6">
...
<!-- This button is only visible to agencies so that no user can add car-->
  <center><button type="submit" class="btn btn-warning" style="width:20%" name="submit">Add Car</button></center>
</form>
        </div>
      </div>
    </div>
