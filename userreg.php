...
$query = "INSERT INTO `user`( `username`, `email`, `password`, `type`) VALUES ('$name','$email','$password','user')";
...
<!-- site metas -->
<title>caRent || User Registration</title>
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="input_main">
              <div class="container">
                <h2 class="request_text">User Registration Page</h2>
                
                <div class="form-group">
                  <form action="" method="post">
                  <input type="text" class="email-bt" placeholder="Enter your Name" name="user_name" required>
                </div>
                <div class="form-group">
                  <input type="text" class="email-bt" placeholder="Enter your Email" name="user_email" required>
                </div>
                <div class="form-group">
                  <input type="password" class="email-bt" placeholder="password" name="user_password" required>
                </div>
                </div>
